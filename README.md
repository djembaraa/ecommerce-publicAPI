...
A premium beauty e-commerce web application featuring a modern, immersive user interface and a seamless shopping experience. Built with Next.js 15, React, and Tailwind CSS.

## Design Philosophy

This project was entirely overhauled following Gestalt Principles and modern UI/UX design patterns:
...
- Design System: Centralized design tokens (CSS custom properties) powering the entire aesthetic with a dark, luxurious theme (--color-primary, --color-accent).

## Features

- Full Authentication State: Context-based authentication simulating login and signup flows.
...
- API Integration: Fully integrated with the DummyJSON API for realistic data fetching.
- Comprehensive Footer Pages: All auxiliary service and support pages are fully rendered statically for a complete user experience.
...
Created and maintained by **Djembar Arafat**.
